plugins/vscode/ — next STATghost host (VS Code / Cursor)
=======================================================
Updated: 2026-08-16
...
"R Editor"). Same identity as `plugins/cudatext/`: menu + workbar +
...
When there is GO (VP-EB-* for this host):
  1. Keep the contract in `shared/` (extract host-agnostic Python
     from `plugins/cudatext/cuda_statghost/` then; do not copy-paste).
