...
Tinn-R_D 16px extracts + generated 24/32 live in `plugins/cudatext/w_todo/icons/`
...
Source drop (full SG copy + extras) lives at `shared/png/` —
same glyphs for every host. Do not ship explorer_filter /
explorer_popup here.
